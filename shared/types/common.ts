...
export interface SermonUpdate { title?: string; content?: Record<string, unknown>; plain_text?: string; preacher?: string | null; cover_id?: string | null; is_favorite?: boolean; last_opened_at?: string | null }
